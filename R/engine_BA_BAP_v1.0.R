...
# Load all function definitions from the v1.0 converter Rmd
knitr::purl("convert_BA_BAP_v022525_v5d_v1.0.Rmd", output = "converter_defs_tmp.R", quiet = TRUE)
source("converter_defs_tmp.R")
